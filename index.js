//Завдання 1.Cтворіть об'єкт person за допомогою конструктора з полями name:
//"John", age: 25
...
// та вкладений об'єкт address з полями  street: "123 Main St", city: "New York",
//country: "USA",
let personLarge = {
...
// Завдання 5: Створіть функцію, що отримує об'єкт і виводить на консоль всі його
//ключі та значення.
let country = {
  name: "United States",
...
let user = {
  name: "John",
  age: 25,
  // Створюємо метод introduce, який за допомогою ключового слова this має
  // повернути такий рядок
...
function destructureObject(obj) {
  // Використовуємо деструктуризацію для створення нових змінних з властивостей
  // об'єкту і отримуємо з нього змінні brand та model
...
// Створюємо масив об'єктів userList, першим елементом якого буде об'єкт
// name: "Jack", role: "reader", а другим об'єкт name: "Jane", role: 'admin'
...
// Завдання 11: Використовуйте вкладені об'єкти для зберігання більш складної
// інформації.
